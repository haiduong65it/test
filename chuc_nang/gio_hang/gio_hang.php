<?php 
	...
	echo "<h1 style='color: red'><strong>Giỏ hàng</strong></h1>";
	echo "<br>";
	echo "<br>";
	if($gio_hang=="khong")
	{
	...
	else 
	{
		...
		echo "<table>";
			echo "<tr>";
				echo "<td width='200px' ><strong>Tên</strong></td>";
				echo "<td width='200px'><strong>Hình ảnh</strong></td>";
				echo "<td width='150px'><strong>Số lượng</strong></td>";
				echo "<td width='150px'><strong>Đơn giá</strong></td>";
				echo "<td width='170px'><strong>Thành tiền</strong></td>";
			echo "</tr>";
			$tong_cong=0;
			for($i=0;$i<count($_SESSION['id_them_vao_gio']);$i++)
			{
			...
			echo "<tr>";
				echo "<td>&nbsp;</td>";
				echo "<td height='50px'><input type='submit' value='Cập nhật' > </td>";
				echo "<td>&nbsp;</td>";
				echo "<td>&nbsp;</td>";
			echo "</tr>";	
		echo "</table>";
